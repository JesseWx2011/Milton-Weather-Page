 ...
 */
function(r, o) {
    "object" == typeof exports && "object" == typeof module ? module.exports = o(r._Highcharts, r._Highcharts.Chart) : "function" == typeof define && define.amd ? define("highcharts/themes/adaptive", ["highcharts/highcharts"], function(r) {
        return o(r, r.Chart)
    }) : "object" == typeof exports ? exports["highcharts/themes/adaptive"] = o(r._Highcharts, r._Highcharts.Chart) : r.Highcharts = o(r.Highcharts, r.Highcharts.Chart)
}("u" < typeof window ? this : window, (r, o) => ( () => {
    "use strict";
    var a, l, h = {
        944: o => {
            o.exports = r
    ...
    c.d = (r, o) => {
        for (var a in o)
            c.o(o, a) && !c.o(r, a) && Object.defineProperty(r, a, {
                enumerable: !0,
                get: o[a]
            })
    }
    ,
    c.o = (r, o) => Object.prototype.hasOwnProperty.call(r, o);
    var e = {};
    c.d(e, {
        default: () => f
    });
...
`;
    (a = l || (l = {})).options = {
        colors: ["var(--highcharts-color-0)", "var(--highcharts-color-1)", "var(--highcharts-color-2)", "var(--highcharts-color-3)", "var(--highcharts-color-4)", "var(--highcharts-color-5)", "var(--highcharts-color-6)", "var(--highcharts-color-7)", "var(--highcharts-color-8)", "var(--highcharts-color-9)"],
        global: {
            buttonTheme: {
        ...
        pane: {
            background: {
                borderColor: "var(--highcharts-neutral-color-20)",
                backgroundColor: {
                    stops: [[0, "var(--highcharts-background-color)"], [1, "var(--highcharts-neutral-color-10)"]]
                }
            }
        },
        zAxis: {
    ...
    a.apply = function() {
        ...
        r.nonce = "highcharts",
        r.innerText = C,
        r.id = "highcharts-adaptive-theme",
        document.getElementsByTagName("head")[0].appendChild(r),
        u(a.options),
        v(g(), "afterGetContainer", function() {
            let o = this.container.getRootNode().host?.shadowRoot;
            if (o && !o.getElementById("highcharts-adaptive-theme")) {
                let a = r.cloneNode(!0);
                o.appendChild(a)
            }
        })
